...
const PlatformAnalytics = ({ chartData, setSelectedYear, selectedYear }) => {
  ...
  return (
    <div className="w-full rounded-xl border bg-white p-6 shadow-lg xl:w-full">
      <div className="mb-10 flex items-center justify-between text-black">
        <h1 className="text-xl font-medium">Platform Analytics </h1>

        <div className="flex items-center justify-start gap-x-4">
          <Select
            value={"earning"}
            options={[
              { value: "2024", label: "User" },
              { value: "2023", label: "Earning" },
              { value: "2022", label: "Salse" },
            ]}
          />
          <DatePicker
